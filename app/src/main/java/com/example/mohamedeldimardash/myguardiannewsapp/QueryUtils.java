...
class QueryUtils {
    ...
    public static List<NewsItem> fetchNewsItems(String requestUrl, Context context) {
        ...
        try {
            ...
            Log.e(LOG_TAG, QueryUtils.context.getString(R.string.exception_http_request), e);
        }
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG, context.getString(R.string.exception_url_invalid), e);
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e(LOG_TAG, context.getString(R.string.exception_resp_code) + urlConnection.getResponseCode());
            }
        } catch (IOException e) {
            Log.e(LOG_TAG, context.getString(R.string.exception_json_results), e);
        } finally {
    ...
    private static String prepareUrl(String url) {
        ...
        uriBuilder.appendQueryParameter(
                context.getString(R.string.setting_show_tags_label),
                context.getString(R.string.setting_show_tags_value));
        uriBuilder.appendQueryParameter(
                context.getString(R.string.setting_show_ref_label),
                context.getString(R.string.setting_show_ref_value));
        uriBuilder.appendQueryParameter(
                context.getString(R.string.setting_api_label),
                context.getString(R.string.setting_api_value));
